  ...
  allProjects: [
    {
      ...
      location: 'npm package',
       desc: ' Dx slider is a customizable React slider  an npm package  with smooth transitions and auto-play functionality. Best used for rendering smaller images into a carousel',
      icon: DX,
