...
export default {
...

  {
    ...
    location: 'Kampala, Uganda',
     desc: 'A Medical Inventory Management System is a digital solution designed to streamline and automate the tracking, ordering, storing, and usage of medical supplies and equipment in healthcare facilities like hospitals, clinics, and pharmacies.',
    icon: SiSi,
