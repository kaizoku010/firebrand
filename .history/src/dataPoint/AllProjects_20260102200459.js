  ...
  allProjects: [
    ...
    
    {
      ...
      location: 'Australia, Sydney',
       desc: 'A digital nation founded by AIME and a network of networks, an unlikely group of human, non-human and imagined beings that knew that the intelligence needed for the scale of the human problems we had created was only going to come from beyond the margins, that would be the source of the collective imaginatio',
      icon: Workflow,
