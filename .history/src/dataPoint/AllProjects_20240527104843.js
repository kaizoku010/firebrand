...
export default {
  ...
  allProjects: [

    {
      ...
      textColor: 'lightBlue',
      location: 'Kampala, Ug',
       desc: ' This systems creates video Ads, monitors available company Android Devices (custom built), their locations, their battery level, their network status, IP Address, and current Video Ad playing, the system comprises both an Android App  ,
      icon: MX5,
