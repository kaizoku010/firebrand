...
export default {
  ...
  allProjects: [

    {
      ...
      textColor: 'lightBlue',
      location: 'Kampala, Ug',
       desc: 'This is an fusion of technologies strung togther to create a custom selfcheckin system that involes more 3 different cross-platform full-stack applications. the system involes 3 Android Apps, where each serves a different purpose 2 react applications meant to monitor and create user/attendee data.',
      icon: MX5,
...

    {
      ...
      textColor: 'lightBlue',
      location: 'Kampala, Ug',
       desc: ' This systems creates video Ads and streams them on custom built mobile Android screen, monitors available company Android Devices (custom built), their locations, their battery level, their network status, IP Address, and current Video Ad playing, the system comprises both an Android App & a React App',
      icon: MX5,
