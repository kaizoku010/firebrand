...
export default {
  ...
  allProjects: [

    {
      ...
      textColor: 'lightBlue',
      location: 'Kampala, Ug',
       desc: ' This systems creates video Ads, monitors available company Android Devices (custom), their locations, their battery level, their network status, IP Address, and current
        Video ad playing',
      icon: GBunnies,
