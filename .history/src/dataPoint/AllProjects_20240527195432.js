...
export default {
  ...
  allProjects: [

    {
      ...
      textColor: 'lightBlue',
      location: 'Kampala, Ug',
       desc: 'This is a fusion of technologies strung togther to create a custom selfcheckin system that involes more than one cross-platform full-stack application. These invole 3 Android Apps, where each serves a different purpose, 2 React applications meant to monitor, create user/attendee data and meta data.',
      icon: MX5,
...

  {
    ...
    textColor: 'lightBlue',
    location: 'Kampala, Ug',
     desc: '  An Artificial Intelligence (AI) powered Integrated Intelligence Information Management System (IIIMS) for Security Agencies. The system is designed to address the challenge of information overload and optimize the utilization of intelligence information. ',
    icon: IIIMS,
