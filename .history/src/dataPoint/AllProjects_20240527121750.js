...
export default {
  ...
  allProjects: [

    {
      ...
      textColor: 'lightBlue',
      location: 'Kampala, Ug',
       desc: 'This is an fusion of technologies strung togther to create a custom selfcheckin system that involes more 3 different cross-platform full-stack applications. the system involes 3 Android Apps, where each serves a different purpose 2 react applications meant to monitor and create user/attendee data, they also manage data like to I  app creates the events, assigns sessions, agendas, durations and prices. It has a list of all created events, attendees per event, ticket sales and event details',
      icon: MX5,
