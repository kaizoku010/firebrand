...
export default {
  ...
  allProjects: [

    {
      ...
      textColor: 'lightBlue',
      location: 'Kampala, Ug',
       desc: 'This is a  app creates the events, assigns sessions, agendas, durations and prices. It has a list of all created events, attendees per event, ticket sales and event details',
      icon: MX5,
