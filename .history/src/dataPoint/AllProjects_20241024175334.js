  ...
  allProjects: [
    {
      ...
      location: 'Kampala, Uganda',
       desc: 'Nsamba Ibrahim Matovu is a seasoned interior and landscape designer with a Bachelors degree in Interior and Landscape Design from Kyambogo University in Kampala (KYU). With a strong academic foundation, he has honed his expertise over seven years in the field, specializing in 3D visualization for residential, commercial, and event design projects',
      icon: DX,
