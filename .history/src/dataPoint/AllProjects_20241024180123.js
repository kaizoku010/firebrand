...
export default {
  ...
  
  {
    ...
    textColor: 'lightBlue',
    location: 'Kampala, Ug',
     desc: 'This is a simple android game built in the honor of my best friend. Help the noble knight Emma annihilate the evil bunny overlord and his zombie minions from the Castle.',
    icon: GBunnies,
