...
export default {
  ...
  allProjects: [

    {
      ...
      textColor: 'lightBlue',
      location: 'Kampala, Ug',
       desc: 'This is an fusion of technologies strung togther to create a custom selfcheckin system that involes more one different cross-platform full-stack applications. These invole 3 Android Apps, where each serves a different purpose, 2 react applications meant to monitor and create user/attendee data.',
      icon: MX5,
