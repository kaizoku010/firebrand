...
export default {
  ...
  allProjects: [
    ...
    {
      id: '145',
      title: "Moxie 5 Events Creator System",
      techStacks: ["React, ", "Google Firebase, ", "Google Play", " React Native", " Pusher", ],
      textColor: 'lightBlue',
      location: 'Kampala, Ug',
       desc: 'This is an fusion of technologies strung togther to create a custom selfcheckin system  app creates the events, assigns sessions, agendas, durations and prices. It has a list of all created events, attendees per event, ticket sales and event details',
      icon: MX5,
