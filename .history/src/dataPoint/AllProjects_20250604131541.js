...
export default {
  ...
  allProjects: [
      ...
      textColor: 'lightBlue',
      location: 'Kampala, Ug',
       desc: 'Code canvas is a study tool designed used by students under code with dixon to learn design, build, and preview stunning UI components with HTML & CSS',
      icon: IIIMS,
