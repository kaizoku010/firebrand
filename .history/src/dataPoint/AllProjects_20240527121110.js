...
export default {
  ...
  allProjects: [
    ...
    {
      id: '145',
      title: "Moxie 5 Selfcheckin System",
      techStacks: ["React, ", "Google Firebase, ", "Google Play", " Pusher", ],
      textColor: 'lightBlue',
      location: 'Kampala, Ug',
       desc: 'This is an fusion of technologies strung togther to create a custom selfcheckin system that involes more 5 different cross-platform applications. the system involes an  to I  app creates the events, assigns sessions, agendas, durations and prices. It has a list of all created events, attendees per event, ticket sales and event details',
      icon: MX5,
