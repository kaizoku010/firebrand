  ...
  allProjects: [
    {
      ...
      location: 'npm package',
       desc: ' Dx slider is a customizable React slider  an npm package  component with smooth transitions and auto-play functionality. Best used for rendering smaller images into a carousel',
      icon: DX,
