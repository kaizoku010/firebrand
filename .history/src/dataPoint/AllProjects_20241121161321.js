...
export default {
...

  {
...

    {
      ...
      textColor: 'lightBlue',
      location: 'Kampala, Uganda',
       desc: 'Nsamba Ibrahim Matovu is a creative seasoned interior and landscape designer with a Bachelors degree in Interior and Landscape Design from Kyambogo University in Kampala (KYU). With a strong academic foundation...',
      icon: Ibrahim,
