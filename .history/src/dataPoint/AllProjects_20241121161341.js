...
export default {
...

  {
...

    {
      ...
      textColor: 'lightBlue',
      location: 'Kampala, Uganda',
       desc: 'Nsamba Ibrahim Matovu is a creative seasoned interior and landscape designer with a Bachelors degree in Interior and Landscape Design, with over 15years of experience from Kyambogo University in Kampala (KYU). With a strong academic foundation...',
      icon: Ibrahim,
