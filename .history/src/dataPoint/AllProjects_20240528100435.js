...
export default {
...

  {
    ...
    textColor: 'lightBlue',
    location: 'Kampala, Ug',
     desc: 'Integrated Intelligence Information Management is an artificial intelligence () powered System (IIIMS) for Security Agencies. The system is designed to address the challenge of information overload and optimize the utilization of intelligence information. ',
    icon: IIIMS,
