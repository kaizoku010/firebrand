  ...
  allProjects: [
    {
      ...
      location: 'npm package',
       desc: ' Dx slider is an npm package that customizable React slider component with smooth transitions and auto-play functionality. Best used for rendering smaller images into a carousel',
      icon: DX,
