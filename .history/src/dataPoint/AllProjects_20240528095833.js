...
export default {
  ...
  allProjects: [

    {
      ...
      textColor: 'lightBlue',
      location: 'Kampala, Ug',
       desc: 'This is a fusion of technologies strung together to create a custom selfcheckin system that involves more than one cross-platform full-stack application. These involve 3 Android Apps, where each serves a different purpose, 2 React applications meant to monitor, create user/attendee data and meta data.',
      icon: MX5,
