...
export default {
  ...
  allProjects: [

    {
      ...
      techStacks: ["React, ", "Google Firebase, ", "Google Play,", " Pusher", ],
      textColor: 'lightBlue',
      location: 'Kampala, Ug',
       desc: 'This is an fusion of technologies strung togther to create a custom selfcheckin system that involes more 3 different cross-platform full-stack applications. the system involes 3 Android Apps, where each serves a different purpose 2 react applications meant to monitor and create user/attendee data, they also work with data like to I  app creates the events, assigns sessions, agendas, durations and prices. It has a list of all created events, attendees per event, ticket sales and event details',
      icon: MX5,
    ...
    {
      id: '145',
      title: "Moxie 5 Video Ad System",
      techStacks: ["React, ", "Google Firebase, ", "Google Play,", " AWS" ],
      textColor: 'lightBlue',
      location: 'Kampala, Ug',
       desc: ' This systems creates video Ads, monitors available company Android Devices (custom built), their locations, their battery level, their network status, IP Address, and current Video Ad playing, the system comprises both an Android App & a React App',
      icon: MX5,
...

  {
    id: '4',
    title: 'NWM Ltd',
    techStacks: ["WordPress", "Custom CSS"],
   ...
   link: 'http://naturewasteug.com/'
...

    {
      id: '445',
      title: "GunBunnies",
      techStacks: ["Android, ", "Google Firebase, ", "Google Play" ],
      textColor: 'lightBlue',
      location: 'Kampala, Ug',
...

    {
      id: '465',
      title: "Nusu",
      techStacks: ["Android, ", "Google Firebase, ", "Google Play, ", "Sqlite Database" ],
      textColor: 'lightBlue',
      location: 'Kampala, Ug',
