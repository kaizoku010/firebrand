...
export default {
...

  {
    ...
    textColor: 'lightBlue',
    location: 'Kampala, Ug',
     desc: '  This aAn Artificial Intelligence powered Integrated Intelligence Information Management System (IIIMS) for Security Agencies. The system is designed to address the challenge of information overload and optimize the utilization of intelligence information. ',
    icon: IIIMS,
