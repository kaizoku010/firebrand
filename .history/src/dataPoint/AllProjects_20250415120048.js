...
export default {
...

  {
    ...
    location: 'Kampala, Uganda',
     desc: 'A Medical Inventory Management System  a digital solution designed to streamline and automate the tracking, ordering, storing, and usage of medical supplies and equipment.',
    icon: SiSi,
