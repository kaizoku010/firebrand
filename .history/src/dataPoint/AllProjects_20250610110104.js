...
export default {
  ...
  allProjects: [
      ...
      location: ' Kirchberg, Luxembourg',
       desc: 'The web-base game that is designed to make participation easy and enjoyable for , encouraging more people to support SembezaAfrica\'s charitable projects.',
      icon: sembeza,
