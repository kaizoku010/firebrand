...
export default {
...

  {
    ...
    textColor: 'lightBlue',
    location: 'Kampala, Ug',
     desc: '  an Artificial Intelligence (AI) powered Integrated Intelligence Information Management System (IIIMS) for Security Agencies. The system will 
     be designed to address the challenge of information overload and optimize the utilization of 
