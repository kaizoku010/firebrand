...
function Blog() {
  ...
  const blogs = [
    { id: 1, title: 'Peacock PRoject', description: 'Discover the power of the Peacock server. Download resources and start exploring.', image:"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQP_9R3lzRksnVnuWHeN9Mo7RWM1pOEd7CjKg&s" },
  ];
