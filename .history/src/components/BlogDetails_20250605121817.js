  ...
  return (
    <>
      ...
      <div className="blog-details">
        ...
        <img src="https://cdn.hashnode.com/res/hashnode/image/upload/v1678134359606/03e5efb6-7ba8-48d9-bba2-4a2700e620e4.png?w=1600&h=840&fit=crop&crop=entropy&auto=compress,format&format=webp" alt="Streaming with Docker" style={{maxWidth: '100%', marginBottom: 20}} />
        <h2>Overview</h2>
        <p>
