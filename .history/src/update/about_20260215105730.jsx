    ...
    <main>
      <div className="about-container">
        ...
        <p className="about-text">
          ...
          I've had the pleasure of working with intresting start companies such as Willapps UG, NoniVie Uganda, Muraka Consults, Kwetu LLC, Moxie 5 Marketing Agency ,Savage Creative Africa,
