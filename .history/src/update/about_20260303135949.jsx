  ...
  return (
    <main>
      <div className="about-container">
        ...
        Software Developer with 10+ years of experience delivering scalable, over the years I have worked with startups in Uganda and around the world to ship cross-platform applications across React, React Native, JavaScript, and Android/Java. Experienced in building full-stack solutions, leading development teams, Passionate about performance, scalability, and creating seamless user experiences. <br/>
          <br/>
