...
function Blog() {
  ...
  const blogs = [
    { id: 1, title: 'Peacock Server', description: 'Discover the power of the Peacock server. Download resources and start exploring.', image:"../img/pp.png" },
  ];
    ...
    <div className="blog-grid">
      {blogs.map((blog) => (
        <div key={blog.id} className="blog-item">
          {blog.id === 1 && <img src={blogs.image} alt="Peacock Server" className="blog-item-image" />}
