  ...
  return (
    <main>
      <div className="about-container">
        ...
        Over the last 10 years, I have worked with tech  startups in Uganda and a few around the world to ship their cross-platform applications across React, React Native, JavaScript, and Android/Java. Experienced in building full-stack solutions, leading development teams, Passionate about performance, scalability, and creating seamless user experiences. <br/>
          <br/>
