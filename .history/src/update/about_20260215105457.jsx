    ...
    <main>
      <div className="about-container">
        ...
        <p className="about-text">
          Hi there! My name is Dixon, kalanzi Dixon thanks for being here.<br/></div>    I'm a software developer with over twelve years of experience - building scalable and
          responsive systems.
          <br />
          <br />
          I've had the pleasure of collaborating with
